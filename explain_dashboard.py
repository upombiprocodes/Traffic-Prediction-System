        ...
        with col_loc:
            ...
            with st.container():
                ...
                if loc and loc['latitude'] is not None:
                    # Fix: Only rerun if location actually changed to prevent infinite loop
                    if loc['latitude'] != st.session_state.global_lat or loc['longitude'] != st.session_state.global_lon:
